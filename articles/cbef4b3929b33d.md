---
title: "Xamarin.Forms (Xamarin.Android) に Azure Notification Hubs からタグを活用して Push 通知を送る"
emoji: "👋"
...
## 3. Azure Notification Hubs デプロイ & 設定
[こちら](https://docs.microsoft.com/ja-jp/azure/notification-hubs/xamarin-notification-hubs-push-notifications-android-gcm#create-a-notification-hub)の公式docに沿って、Azure Notification Hubをデプロイする。デプロイが終わったら、
以下の3点に注意しておく。
...
![google-service.png](./google-service.png "全体像")
